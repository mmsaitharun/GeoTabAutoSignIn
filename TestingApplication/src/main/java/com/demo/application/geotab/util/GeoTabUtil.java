...
//			logger.info("[geotab] Entity Response from API : "+obj);
	...
	public static JSONObject callRest(String entity) {

		URL url;
		JSONObject obj = null;
		try {
			url = new URL(GeoTabConstants.GEO_TAB_BASE_URL);
...
//		}
	...
	public static ResponseMessage signInUsers(GeoTabDao geoTabDao) {
...
//					if(deviceStatus.getDeviceId().equals("b7")) {
						...
						if(crowFlyDistance < GeoTabConstants.GEO_TAB_AUTO_SIGNIN_DISTANCE) {
							...
							deviceInfo.setRoadDistance(ArcGISUtil.getRoadDistance(well, device));
...
//								durationBreakdown = GeoTabUtil.getDurationBreakdown(finalDateTime);
								...
								seperateDateTime = GeoTabUtil.seperateDateTime(deviceInfo.getCurrentStateDuration());
								Long parkedTime = seperateDateTime + (dateFormat.parse(deviceInfo.getDateTime())).getTime();
...
//		System.out.println(formDeviceStatusInfoEntity());
		...
		System.out.println(GeoTabUtil.seperateDateTime("01.00:00:19"));
	}
	
	public static Date getParkedTime(DateTimeDto dateTimeDto) throws java.text.ParseException {
	...
	public static DateTimeDto getDurationBreakdown(Long millis) {
	...
	public static Long seperateDateTime(String dateTimeString) {
		...
		if(dateTimeString.contains(".")) {
			...
			if(array.length == 3) {
				...
				ret = GeoTabUtil.convertToMilliSeconds(Long.valueOf(date), GeoTabConstants.GEO_TAB_TIME_DAY) + GeoTabUtil.convertToMilliSeconds(Long.valueOf(hours), GeoTabConstants.GEO_TAB_TIME_HOUR) + GeoTabUtil.convertToMilliSeconds(Long.valueOf(minutes), GeoTabConstants.GEO_TAB_TIME_MINUTE) + GeoTabUtil.convertToMilliSeconds(Long.valueOf(seconds), GeoTabConstants.GEO_TAB_TIME_SECOND) + GeoTabUtil.convertToMilliSeconds(Long.valueOf(milliSeconds), GeoTabConstants.GEO_TAB_TIME_MILLISECOND);
			...
			ret = GeoTabUtil.convertToMilliSeconds(Long.valueOf(hours), GeoTabConstants.GEO_TAB_TIME_HOUR) + GeoTabUtil.convertToMilliSeconds(Long.valueOf(minutes), GeoTabConstants.GEO_TAB_TIME_MINUTE) + GeoTabUtil.convertToMilliSeconds(Long.valueOf(seconds), GeoTabConstants.GEO_TAB_TIME_SECOND); 
		}
